...
try{
	...
	$sql2 = "insert into shop(shop_id,shop_name,phone,browser_num,createdate) 
					value(:shop_id,:shop_name,:phone,'1',NOW())";
	...
	$sql = "insert into shopscore(score_id,score,create_time,shop_id) 
					value('josh1111','5','2017-06-05',:shop_id)";

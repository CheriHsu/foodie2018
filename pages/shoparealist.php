...
// 	//上傳圖片
// 	
			// $from = $_FILES["theFile01"]["tmp_name"];
		 //    $to = "../assets/images/shopProduct/" .mb_convert_encoding($_FILES["theFile01"]["name"],"big5","utf-8");;
		 //    copy($from, $to);

		 //    $from = $_FILES["theFile02"]["tmp_name"];
		 //    $to = "../assets/images/shopProduct/" .mb_convert_encoding($_FILES["theFile01"]["name"],"big5","utf-8");;
		 //    copy($from, $to);

		 //    $from = $_FILES["theFile03"]["tmp_name"];
		 //    $to = "../assets/images/shopProduct/" .mb_convert_encoding($_FILES["theFile01"]["name"],"big5","utf-8");;
		 //    copy($from, $to);

		 //    $from = $_FILES["theFile04"]["tmp_name"];
		 //    $to = "../assets/images/shopProduct/" .mb_convert_encoding($_FILES["theFile01"]["name"],"big5","utf-8");;
		 //    copy($from, $to);

		 //    $from = $_FILES["theFile05"]["tmp_name"];
		 //    $to = "../assets/images/shopProduct/" .mb_convert_encoding($_FILES["theFile01"]["name"],"big5","utf-8");;
		 //    copy($from, $to);

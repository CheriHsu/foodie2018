...
//    $order_amount = $_POST['order_amount'];
    ...
    // $conn = new mysqli('localhost', 'root', 'hxios56', 'foodie');
    // Check connection
    if ($conn->connect_error) {
        die("Connection failed: " . $conn->connect_error);
    }

//    die(var_dump($product_id != "" && $_SESSION['mem']['name'] != ""));
    if ($product_id != "" && $_SESSION['mem']['name'] != "") {
        ...
        foreach($_SESSION['cart_item'] as $item){
            ...
            $stmt = $conn->query("INSERT INTO `order_item` (`order_id`,`product_id`,quantity,price)
                ...
                while ($prod = $shop->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="col-xs-12 col-sm-6 ">
                        <div class="shopOrder-info">
                           <img src="../assets/images/sripic/<?php echo $prod["shop_image"]; ?>" alt="小照片1"/>
            ...
            <div class="col-xs-12 col-sm-12">
                <table class="col">
                    ...
                    foreach ($array as $key => $value) {
                        ...
                        echo "<td data-th='商品圖片'><img src='../assets/images/shopProduct/" . $array[$key]['img'] . "'></td>";
...
//                        echo "<input type='submit' value='Add' class='btnAddAction'/>";
                ...
                <button class="orderlistBtn orderplace2" id="showform">查看購買清單</button>
            </div>
            <div class="clearfix"></div>
        </div>
            ...
            <div class="order-container2">
                <div class="ordermargin col-xs-12 col-sm-12">
                    <table class="sessionTable" cellpadding="10" cellspacing="1">
                        ...
                        foreach ((array)$_SESSION["cart_item"] as $item) {

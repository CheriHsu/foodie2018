...
$stmt->bindParam(':content', $shop_message);
$stmt->bindParam(':is_delete', $is_delete);
$stmt->bindParam(':create_date', $message_date);
$stmt->bindParam(':member_id',$member_id);
$stmt->bindParam(':shop_id',$shop_id);
$stmt->bindParam(':message_id',$message_id);
...
<?php
        ...
        <div class="ShopResultItem-Infomation col-sm-10 col-xs-10">
            ...
            <div class="ShopResultItem-Message">
                ...
                try {
                    $sql = "SELECT m.memarea,s.* from mem_message s join member m WHERE m.name = s.name AND s.is_delete = '0' order by message_date DESC limit 0,2";

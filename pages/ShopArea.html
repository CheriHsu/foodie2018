	...
	<div class="ShopArea-width">
		...
		<div class="col-sm-2 col-xs-12">
			<div class="ShopArea-box">
				...
				<div class="leftFont tablinks active" onclick="shopArea(event,'ShopAreaInfo')"><a href="javascript:;">帳號資訊設定</a></div>
				...
				<div class="leftFont tablinks"  onclick="shopArea(event,'ShopAreaPromo')"><a href="javascript:;">優惠活動管理</a></div>
				<div class="clearfix"></div>
			</div>
		</div>
      ...
      <!-- 帳號資訊設定 -->
              ...
              <div class="ShopAreaInfo-box tabcontent" id="ShopAreaInfo">
                          ...
                          <div class="ShopAreaInfo-info">
                            <ul>
                              ...
                              <li>
                                <div class="ShopAreaInfo-text">舊密碼：<input type="password" class="ShopAreaInfo-inp" value="<?php echo $_SESSION["password"]?>" id="shopPass"/></div>
                                <div class="clearfix"></div>
                              </li>
                              <li>
                                <div class="ShopAreaInfo-text">新密碼：<input type="password" class="ShopAreaInfo-inp" value="<?php echo $_SESSION["password"]?>"/></div>
                                <div class="clearfix"></div>
                              </li>
                              <li>
          ...
          <!-- 營業資訊編輯 -->
      <form id="ShopAreaShopInfo-list" name="ShopAreaShopInfo-list" method="get" action="shoparealist.php">
...
<script type="text/javascript">
  $('#ShopAreaShopInfo-list').submit(function(event){
    // code goes here
    // alert("l2");
             ...
             <div class="ShopAreaItem-box tabcontent" id="ShopAreaItem">
                           ...
                           <div class="col-sm-10 col-xs-12">
                             ...
                             <div class="ShopAreaItem-commodity">
                               <ul>
                                 <a href="javascript:;"><li class="itemlinks shopItem" onclick="openItem(event, 'item1')">商品一</li></a>
...
<form method="post" action="ProductImg.php" enctype="multipart/form-data" >
  ...
  <!-- <input type="submit" value="送出" class="ShopAreaItem-delete" id="Product_img"> -->
                              ...
                              <div class="ShopAreaItem-introduction">
                                ...
                                <a href="javascript:;"><div class="ShopAreaItem-submit" id="Product_modification">更新</div></a>
                                          <div class="con1 col-sm-1 col-xs-0"></div>
                                          <div class="clearfix"></div>
...
<form method="post" action="ProductImg.php" enctype="multipart/form-data" >
  ...
  <!-- <input type="submit" value="送出" class="ShopAreaItem-delete" id="Product_img2"> -->
                              ...
                              <div class="ShopAreaItem-introduction">
                                ...
                                <a href="javascript:;"><div class="ShopAreaItem-submit" id="Product_modification2">更新</div></a>
                                          <div class="con1 col-sm-1 col-xs-0"></div>
                                          <div class="clearfix"></div>
...
<form method="post" action="ProductImg.php" enctype="multipart/form-data" >
  ...
  <!-- <input type="submit" value="送出" class="ShopAreaItem-delete" id="Product_img3"> -->
                              ...
                              <div class="ShopAreaItem-introduction">
                                ...
                                <a href="javascript:;"><div class="ShopAreaItem-submit" id="Product_modification3">更新</div></a>
                                          <div class="con1 col-sm-1 col-xs-0"></div>
                                          <div class="clearfix"></div>
...
<form method="post" action="ProductImg.php" enctype="multipart/form-data" >
  ...
  <!-- <input type="submit" value="送出" class="ShopAreaItem-delete" id="Product_img4"> -->
                              ...
                              <div class="ShopAreaItem-introduction">
                                ...
                                <a href="javascript:;"><div class="ShopAreaItem-submit" id="Product_modification4">更新</div></a>
                                          <div class="con1 col-sm-1 col-xs-0"></div>
                                          <div class="clearfix"></div>
...
<form method="post" action="ProductImg.php" enctype="multipart/form-data" >
 ...
 <!--  <input type="submit" value="送出" class="ShopAreaItem-delete" id="Product_img5"> -->
                              ...
                              <div class="ShopAreaItem-introduction">
                                ...
                                <a href="javascript:;"><div class="ShopAreaItem-submit" id="Product_modification5">更新</div></a>
                                          <div class="con1 col-sm-1 col-xs-0"></div>
                                          <div class="clearfix"></div>
              ...
              <h2>訂單查詢</h2>
                ...
                <div class="col-sm-10 col-xs-12">
                  <div class="ShopAreaOrder-time">
                    ...
                    <input type="button" id="ShopAreaOrder_info" value="查詢" onclick="ya()">
                  </div>
              ...
              <div class="col-sm-10 col-xs-10">
                ...
                <div class="ShopAreaPromo-activity">
                  <div class="col-sm-5  col-xs-12">
                    <div class="ShopAreaPromo-offer"><img src="../assets/images/shopresultitem/shopbuy.jpg"></div>
                  </div>
                  <div class="col-sm-5 col-xs-12">
